  ...
  <nav class="sidebar-nav">
    <div class="sidebar-section">
      <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item <?php echo ($current_page == 'add_new_record' || $current_page == 'new_record') ? 'active' : ''; ?>">
          <a href="new_record.php" target="_blank" class="sidebar-link">
            <i class="fa-solid fa-square-plus" style="color:#71cbae"></i>
            <span>Add New Record</span>
          </a>
        </li>
        <li class="sidebar-menu-item <?php echo ($current_page == 'upload_record') ? 'active' : ''; ?>">
          <a href="upload_record.php" class="sidebar-link">
            <i class="fa-solid fa-file-arrow-up" style="color:#c19149"></i>
            <span>Upload Record</span>
          </a>
        </li>
        <li class="sidebar-menu-item <?php echo ($current_page == 'my_records') ? 'active' : ''; ?>">
          <a href="my_records.php" class="sidebar-link">
